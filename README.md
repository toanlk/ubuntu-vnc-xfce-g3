...
- [Headless Ubuntu/Xfce containers with VNC/noVNC](#headless-ubuntuxfce-containers-with-vncnovnc)
  - [Project `toanlk/ubuntu-vnc-xfce-g3`](#project-toanlkubuntu-vnc-xfce-g3)
...
- [toanlk/ubuntu-vnc-xfce-g3][toanlk-docker-ubuntu-vnc-xfce-g3]
- [toanlk/ubuntu-vnc-xfce-chromium-g3][toanlk-docker-ubuntu-vnc-xfce-chromium-g3]
- [toanlk/ubuntu-vnc-xfce-firefox-g3][toanlk-docker-ubuntu-vnc-xfce-firefox-g3]
...
There are also another sibling projects containing images for headless diagramming, drawing, image processing and modelling ([toanlk/headless-drawing-g3][toanlk-github-headless-drawing-g3]) and for headless programming ([toanlk/headless-coding-g3][toanlk-github-headless-coding-g3]).
...
- [toanlk/ubuntu-vnc-xfce-g3][this-readme-ubuntu-vnc-xfce-g3]
- [toanlk/ubuntu-vnc-xfce-chromium-g3][this-readme-ubuntu-vnc-xfce-chromium-g3]
- [toanlk/ubuntu-vnc-xfce-firefox-g3][this-readme-ubuntu-vnc-xfce-firefox-g3]
...
Now there will be only one Docker Hub repository `toanlk/ubuntu-vnc-xfce-g3`.
...
Check this [Wiki page](https://github.com/toanlk/xubuntu-vnc/wiki/Version-sticker) for more information.
...
However, the `version-sticker` label is in the namespace `any.toanlk` for obvious reasons.
...
The startup script has been completely redesigned with the help of the [argbash][argbash-doc] tool and the image [toanlk/argbash-docker][toanlk-docker-argbash-docker].
...
[this-wiki-how-to-fork]: https://github.com/toanlk/ubuntu-vnc-xfce-g3/wiki/How-to-fork

[this-folder-docker]: https://github.com/toanlk/ubuntu-vnc-xfce-g3/tree/master/docker

[this-folder-docker-hooks]: https://github.com/toanlk/ubuntu-vnc-xfce-g3/tree/master/docker/hooks

[this-example-secrets-file]: https://github.com/toanlk/ubuntu-vnc-xfce-g3/blob/master/examples/example-secrets.rc

[this-readme-ubuntu-vnc-xfce-g3]: https://github.com/toanlk/ubuntu-vnc-xfce-g3/blob/master/docker/xfce/README.md

[this-readme-ubuntu-vnc-xfce-chromium-g3]: https://github.com/toanlk/ubuntu-vnc-xfce-g3/blob/master/docker/xfce-chromium/README.md

[this-readme-ubuntu-vnc-xfce-firefox-g3]: https://github.com/toanlk/ubuntu-vnc-xfce-g3/tree/master/docker/xfce-firefox
...
[this-readme-builder]: https://github.com/toanlk/ubuntu-vnc-xfce-g3/blob/master/readme-builder.md

[this-readme-ci-builder]: https://github.com/toanlk/ubuntu-vnc-xfce-g3/blob/master/readme-ci-builder.md

[this-readme-g3-cache]: https://github.com/toanlk/ubuntu-vnc-xfce-g3/blob/master/readme-g3-cache.md

[this-readme-util-readme-examples]: https://github.com/toanlk/ubuntu-vnc-xfce-g3/blob/master/utils/readme-util-readme-examples.md

[toanlk-docker-ubuntu-vnc-xfce-g3]: https://hub.docker.com/r/toanlk/ubuntu-vnc-xfce-g3

[toanlk-docker-ubuntu-vnc-xfce-chromium-g3]: https://hub.docker.com/r/toanlk/ubuntu-vnc-xfce-chromium-g3

[toanlk-github-xubuntu-vnc-novnc]: https://github.com/toanlk/xubuntu-vnc-novnc/

[toanlk-docker-ubuntu-vnc-xfce-firefox-g3]: https://hub.docker.com/r/toanlk/ubuntu-vnc-xfce-firefox-g3

[toanlk-docker-argbash-docker]: https://hub.docker.com/r/toanlk/argbash-docker
...
[badge-github-release-date]: https://img.shields.io/github/release-date/toanlk/ubuntu-vnc-xfce-g3?logo=github

[badge-github-stars]: https://badgen.net/github/stars/toanlk/ubuntu-vnc-xfce-g3?icon=github&label=stars

[badge-github-forks]: https://badgen.net/github/forks/toanlk/ubuntu-vnc-xfce-g3?icon=github&label=forks

[badge-github-releases]: https://badgen.net/github/releases/toanlk/ubuntu-vnc-xfce-g3?icon=github&label=releases

[badge-github-commits]: https://badgen.net/github/commits/toanlk/ubuntu-vnc-xfce-g3?icon=github&label=commits

[badge-github-last-commit]: https://badgen.net/github/last-commit/toanlk/ubuntu-vnc-xfce-g3?icon=github&label=last%20commit

[badge-github-closed-issues]: https://badgen.net/github/closed-issues/toanlk/ubuntu-vnc-xfce-g3?icon=github&label=closed%20issues

[badge-github-open-issues]: https://badgen.net/github/open-issues/toanlk/ubuntu-vnc-xfce-g3?icon=github&label=open%20issues

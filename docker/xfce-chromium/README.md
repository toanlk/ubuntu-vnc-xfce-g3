...
This GitHub project folder contains resources used by building Ubuntu images available on Docker Hub in the repository [toanlk/ubuntu-vnc-xfce-chromium-g3][this-docker].
...
[this-docker]: https://hub.docker.com/r/toanlk/ubuntu-vnc-xfce-chromium-g3/

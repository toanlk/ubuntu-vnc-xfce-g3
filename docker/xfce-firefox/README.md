...
This GitHub project folder contains resources used by building Ubuntu images available on Docker Hub in the repository [toanlk/ubuntu-vnc-xfce-firefox-g3][this-docker].
...
[this-docker]: https://hub.docker.com/r/toanlk/ubuntu-vnc-xfce-firefox-g3/
